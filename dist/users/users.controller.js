        ...
        try {
            ...
            if (!user) {
                return {
                    ...
                    message: response_message_1.message.notFound,
                    response: {},
                };
            }
            return {
                status: common_1.HttpStatus.OK,
                message: response_message_1.message.successFetched,
                response: user,
            };
        }
        catch (error) {
    ...
    async update(request, updateUserDto) {
        try {
            ...
            if (findByEmail) {
                return {
                    status: common_1.HttpStatus.BAD_REQUEST,
                    message: response_message_1.message.alreadyInUse,
                    response: {},
                };
            }
            if (updateUserDto.alternate_email === updateUserDto.email &&
                ...
                return {
                    status: common_1.HttpStatus.BAD_REQUEST,
                    message: response_message_1.message.emailSame,
                    response: {},
                };
            }
            const modify = {
            ...
            return {
                ...
                message: response_message_1.message.successUpdate,
                response: {},
            };
        }
        catch (error) {
    ...
    async resetPassword(request, resetPassDTO) {
        try {
            ...
            if (await bcrypt.compare(resetPassDTO.currentPass, user.password)) {
                ...
                return {
                    status: common_1.HttpStatus.OK,
                    message: response_message_1.message.successChangedPass,
                    response: {},
                };
            }
            else {
                return {
                    status: common_1.HttpStatus.BAD_REQUEST,
                    message: response_message_1.message.passWrong,
                    response: {},
                };
            }
        }
...
__decorate([
    ...
    (0, swagger_1.ApiAcceptedResponse)({
        description: response_message_1.message.successUpdate,
    }),
    (0, swagger_1.ApiNotFoundResponse)({
        description: response_message_1.message.notFound,
    }),
    (0, swagger_1.ApiBadRequestResponse)({
        description: response_message_1.message.alreadyInUse,
    }),
...
__decorate([
    ...
    (0, swagger_1.ApiOkResponse)({
        description: response_message_1.message.successChangedPass,
    }),
    (0, swagger_1.ApiBadRequestResponse)({
        description: response_message_1.message.tryDiffPass,
    }),
    (0, swagger_1.ApiNotFoundResponse)({
        description: response_message_1.message.notFound,
    }),
