        ...
        try {
            ...
            if (findCompany) {
                return {
                    ...
                    message: response_message_1.message.alreadyUseName,
                    response: {},
                };
            }
...
__decorate([
    ...
    (0, swagger_1.ApiCreatedResponse)({
        description: response_message_1.message.RegisterCompanySuccess,
    }),
    (0, swagger_1.ApiUnauthorizedResponse)({
        description: 'Unauthorized',
    }),
    (0, swagger_1.ApiBadRequestResponse)({
        description: response_message_1.message.alreadyUseName,
    }),
    (0, swagger_1.ApiBody)({ type: create_company_dto_1.default }),
