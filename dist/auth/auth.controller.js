...
let AuthController = class AuthController {
        ...
        try {
            ...
            if (findUser) {
                return {
                    ...
                    message: response_message_1.message.alreadyUseEmail,
                    response: {},
                };
            }
            ...
            return {
                ...
                message: response_message_1.message.RegisterUserSuccess,
                response: {
                    id: user.id,
        ...
        try {
            ...
            if (!user) {
                return {
                    ...
                    error: response_message_1.message.notFound,
                    response: {},
                };
            }
            if (await bcrypt.compare(loginDTO.password, user.password)) {
                ...
                return {
                    ...
                    message: response_message_1.message.loginSuccess,
                ...
                return {
                    status: common_1.HttpStatus.BAD_REQUEST,
                    message: response_message_1.message.notMatchPassword,
                    response: {},
                };
            }
        }
    ...
    googleAuthRedirect(req) {
        if (!req.user) {
            return response_message_1.message.noUser;
        }
    ...
    async forgotPassword(forgotPasswordDTO) {
        try {
            ...
            user.otp = (0, service_util_1.generateOTP)();
            ...
            return {
                status: common_1.HttpStatus.OK,
                message: response_message_1.message.successSent,
                response: {},
            };
        }
        catch (error) {
    ...
    async forgotPasswordVerify(verifyDTO) {
        try {
            ...
            if (user.otp !== verifyDTO.otp) {
                return {
                    status: common_1.HttpStatus.BAD_REQUEST,
                    message: response_message_1.message.notMatchOTP,
                    response: {},
                };
            }
            if (await bcrypt.compare(verifyDTO.confirmPassword, user.password)) {
                return {
                    status: common_1.HttpStatus.BAD_REQUEST,
                    message: response_message_1.message.tryDiffPass,
                    response: {},
                };
            }
            if (moment(user.code_expiry).isBefore(moment())) {
                return {
                    status: common_1.HttpStatus.BAD_REQUEST,
                    message: response_message_1.message.otpExpire,
                    response: {},
                };
            }
            ...
            return {
                status: common_1.HttpStatus.OK,
                message: response_message_1.message.successReset + user.email,
                response: {},
            };
        }
        catch (error) {
...
__decorate([
    ...
    (0, swagger_1.ApiBadRequestResponse)({
        description: response_message_1.message.alreadyUseEmail,
    }),
...
__decorate([
    ...
    (0, swagger_1.ApiOkResponse)({
        description: response_message_1.message.loginSuccess,
    }),
...
__decorate([
    ...
    (0, swagger_1.ApiOkResponse)({
        description: response_message_1.message.successSent,
    }),
...
__decorate([
    ...
    (0, swagger_1.ApiOkResponse)({
        description: response_message_1.message.successReset,
    }),
