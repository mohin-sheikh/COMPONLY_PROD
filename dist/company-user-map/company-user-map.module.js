...
CompanyUserMapModule = __decorate([
    (0, common_1.Module)({
        ...
        controllers: [],
        providers: [company_user_map_service_1.CompanyUserMapService],
        exports: [company_user_map_service_1.CompanyUserMapService],
    })
], CompanyUserMapModule);
exports.CompanyUserMapModule = CompanyUserMapModule;
//# sourceMappingURL=company-user-map.module.js.map